    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-blue-50 to-white">
      ...
      <div className="pt-4 pb-4 px-4">
        ...
        <div className="text-center">
          <h1 className="text-4xl font-bold text-blue-600 mb-2">サクイチ</h1>
          <p className="text-base text-gray-600">サクッと一問一答で簡単暗記！</p>
        </div>
      </div>

      {/* お知らせバナー */}
      <div className="px-4 sm:px-6 mb-4">
        <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-100 rounded-2xl p-4 sm:p-5">
          {/* お試し期間バッジ */}
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              不具合があるかもしれませんが、ご了承ください。
              <br className="sm:hidden" />
              <span className="hidden sm:inline">　</span>
              お気づきの点があればご連絡いただけると嬉しいです！
            </p>
          </div>
        </div>
      </div>
